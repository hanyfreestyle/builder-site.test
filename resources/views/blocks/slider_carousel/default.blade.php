<div class="container-fluid p-0 mb-5 slider-carousel-block">
                            ...
                            <div class="col-10 col-lg-8">
                                ...
                                <div class="buttons-wrapper">
                                    @if(isset($slide['primary_button']['url']) && !empty($slide['primary_button']['url']))
                                        <a href="{{ $slide['primary_button']['url'] }}" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">
                                            {{ $slide['primary_button']['text'] ?? 'Read More' }}
                                        </a>
                                    @endif
                                    
                                    @if(isset($slide['secondary_button']['url']) && !empty($slide['secondary_button']['url']))
                                        <a href="{{ $slide['secondary_button']['url'] }}" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">
